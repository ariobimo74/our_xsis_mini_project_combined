package com.xsis.xsis.model.vac_prof_respro;
...
import com.xsis.xsis.dto.vac_prof_respro.ResourceProDto;
...
@SqlResultSetMapping(name = "resourceProjectMapping", classes = {
        @ConstructorResult(targetClass = ResourceProDto.class, columns = {
                @ColumnResult(name = "id", type = Long.class), @ColumnResult(name = "client_id", type = Long.class),
...
@NamedNativeQuery(name = "ResourceProject.getPagingResourceProjectClientEmployee", query = "select a.id,a.client_id,a.start_project,a.end_project,a.department,a.pic_name,"
...
@NamedNativeQuery(name = "ResourceProject.getResourceProjectClientEmployee", query = "select a.id,a.client_id,a.start_project,a.end_project,a.department,a.pic_name,"
        + "b.name,b.user_client_name,b.ero,c.is_ero from x_resource_project a "
        + "join x_client b on b.id=a.client_id join x_employee c on c.id=b.ero "
        + "where (a.isdelete=false and b.isdelete=false and c.isdelete=false) order by a.start_project, a.end_project asc", resultSetMapping = "resourceProjectMapping")

// Page & Sorting Resource Project Join Client Join Employee
@NamedNativeQuery(name = "ResourceProject.getResourceProjectClientEmployeePandS", query = "select a.id,a.client_id,a.start_project,a.end_project,a.department,a.pic_name,"
        + "b.name,b.user_client_name,b.ero,c.is_ero from x_resource_project a "
        + "join x_client b on b.id=a.client_id join x_employee c on c.id=b.ero "
...
@NamedNativeQuery(name = "ResourceProject.getResourceProjectClientEmployeeAscending", query = "select a.id,a.client_id,a.start_project,a.end_project,a.department,a.pic_name,"
        + "b.name,b.user_client_name,b.ero,c.is_ero from x_resource_project a "
        + "join x_client b on b.id=a.client_id join x_employee c on c.id=b.ero "
...
@NamedNativeQuery(name = "ResourceProject.getResourceProjectClientEmployeeDescending", query = "select a.id,a.client_id,a.start_project,a.end_project,a.department,a.pic_name,"
        + "b.name,b.user_client_name,b.ero,c.is_ero from x_resource_project a "
        + "join x_client b on b.id=a.client_id join x_employee c on c.id=b.ero "
...
@NamedNativeQuery(name = "ResourceProject.searchDateResourceProject", query = "select a.id,a.client_id,a.start_project,a.end_project,a.department,a.pic_name,"
        + "b.name,b.user_client_name,b.ero,c.is_ero from x_resource_project a "
        + "join x_client b on b.id=a.client_id join x_employee c on c.id=b.ero "
...
@NamedNativeQuery(name = "ResourceProject.searchNameClientResourceProject", query = "select a.id,a.client_id,a.start_project,a.end_project,a.department,a.pic_name,"
        + "b.name,b.user_client_name,b.ero,c.is_ero from x_resource_project a "
        + "join x_client b on b.id=a.client_id join x_employee c on c.id=b.ero "
        + "where (a.isdelete=false and b.isdelete=false and c.isdelete=false) and "
