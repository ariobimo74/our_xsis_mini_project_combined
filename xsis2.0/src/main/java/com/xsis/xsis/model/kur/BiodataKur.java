...
public class BiodataKur extends CommonEntity {
    ...
    public BiodataKur(Long id, String fullName, String nickName, String pob, Date dob, Boolean gender, Long religionId,
