...
@NamedNativeQuery(name = "Sertifikasi.getSertifikasiBiodata", query = "select a.id,a.biodata_id,a.certificate_name,a.publisher,a.valid_start_year,a.until_year from x_sertifikasi a "
