...
public class BiodataDika extends CommonEntity {
    ...
    public BiodataDika(Long id, String fullName, String nickName, String pob, Date dob, Boolean gender, Long religionId,
