...
public class EmployeeAlfia extends CommonEntity {
    ...
    public EmployeeAlfia() {
    }

    public EmployeeAlfia(Long biodataId, Boolean isIdle, Boolean isEro, Boolean isUserClient, String eroEmail) {
