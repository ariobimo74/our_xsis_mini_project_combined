...
@SqlResultSetMapping(name = "pengkerAlfiaMapping", classes = {
        @ConstructorResult(targetClass = BiodataPengkerDtoAlfia.class, columns = {
...
@NamedNativeQuery(name = "PengalamanKerjaAlfia.getBioId", query = "select a.id,a.isdelete,a.biodata_id,a.company_name,a.join_year,a.join_month,a.resign_year,a.resign_month,a.notes"
        + " from x_riwayat_pekerjaan as a where a.biodata_id=:biodataId and isdelete=false", resultSetMapping = "pengkerAlfiaMapping")

@Entity
@Table(name = "x_riwayat_pekerjaan")
public class PengalamanKerjaAlfia extends CommonEntity {
    ...
    public PengalamanKerjaAlfia() {
    }

    public PengalamanKerjaAlfia(Long biodataId, String companyName, String city, String country, String joinYear,
