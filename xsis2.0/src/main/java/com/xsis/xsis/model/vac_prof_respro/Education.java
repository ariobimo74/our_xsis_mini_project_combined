...
@SqlResultSetMapping(name = "educationMapping", classes = { @ConstructorResult(targetClass = EduDto.class, columns = {
        ...
        @ColumnResult(name = "country", type = String.class), @ColumnResult(name = "entry_year", type = String.class),
...
@SqlResultSetMapping(name = "lastEducationMapping", classes = {
        @ConstructorResult(targetClass = LastEduDto.class, columns = {
...
@NamedNativeQuery(name = "Education.getEduName", query = "select a.id,a.education_level_id,a.biodata_id,a.school_name,b.name,a.country,a.entry_year,a.graduation_year,a.major,a.gpa from x_riwayat_pendidikan a "
...
@NamedNativeQuery(name = "Education.getLastEducation", query = "select a.school_name,a.major from x_riwayat_pendidikan a "
        + "join x_education_level b on b.id=a.education_level_id where a.biodata_id=:biodataId and a.isdelete=false and b.isdelete=false order by a.graduation_year desc limit 1", resultSetMapping = "lastEducationMapping")

// Get Detail Education Join Biodata
@NamedNativeQuery(name = "Education.getEduNameDetail", query = "select a.id,a.education_level_id,a.biodata_id,a.school_name,a.entry_year,a.graduation_year,a.major,a.gpa from x_riwayat_pendidikan a "
