package com.xsis.xsis.model.kur.entity;
...
@SqlResultSetMapping(name = "pengkerMapping", classes = {
        @ConstructorResult(targetClass = BiodataPengkerDtoKur.class, columns = {
                ...
                @ColumnResult(name = "join_month", type = String.class),
                @ColumnResult(name = "join_year", type = String.class),
                @ColumnResult(name = "resign_month", type = String.class),
                @ColumnResult(name = "resign_year", type = String.class),
                @ColumnResult(name = "notes", type = String.class) }) })

// List Category Join Brand
@NamedNativeQuery(name = "PengalamanKerjaKur.getBioId", query = "select a.id,a.isdelete,a.biodata_id,a.company_name,a.join_month,a.join_year,a.resign_month,a.resign_year,a.notes"
        + " from x_riwayat_pekerjaan as a where a.biodata_id=:biodataId and isdelete=false", resultSetMapping = "pengkerMapping")

@Entity
@Table(name = "x_riwayat_pekerjaan")
public class PengalamanKerjaKur extends CommonEntity {
    ...
    public PengalamanKerjaKur() {
    }

    public PengalamanKerjaKur(Long biodataId, String companyName, String city, String country, String joinYear,
