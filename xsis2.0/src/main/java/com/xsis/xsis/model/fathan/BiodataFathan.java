...
public class BiodataFathan extends CommonEntity {
    ...
    public BiodataFathan() {
    }

    public BiodataFathan(Long id, String fullName, String nickName, String pob, Date dob, Boolean gender,
            Long religionId, Integer hight, Integer weight, String nationality, String ethnic, String hobby,
            Long identityTypeId, String email, String identityNo, String phoneNumber1, String phoneNumber2,
            String parentPhoneNumber, String childSequence, String howManyBrothers, Long maritalStatusId,
            Long addrbookId, String token, Date expiredToken, String marriageYear, Long companyId, Boolean isProcess,
            Boolean isComplete) {
        this.id = id;
