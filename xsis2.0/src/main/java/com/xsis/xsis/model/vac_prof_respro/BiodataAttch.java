...
@NamedNativeQuery(name = "BiodataAttch.getBiodataAttachment", query = "select a.id,a.biodata_id,a.file_name,a.file_path,a.notes,a.is_photo from x_biodata_attachment a "
