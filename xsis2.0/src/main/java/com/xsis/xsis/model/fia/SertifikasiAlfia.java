...
@SqlResultSetMapping(name = "sertifikasiAlfiaMapping", classes = {
        @ConstructorResult(targetClass = SertifikasiBioDtoAlfia.class, columns = {
                ...
                @ColumnResult(name = "valid_start_month", type = String.class),
                @ColumnResult(name = "until_year", type = String.class),
                @ColumnResult(name = "until_month", type = String.class), }) })

// List Category Join Brand
@NamedNativeQuery(name = "SertifikasiAlfia.getBioId", query = "select a.id,a.isdelete,a.biodata_id,a.certificate_name,a.publisher,a.valid_start_year,a.valid_start_month,a.until_year,a.until_month"
        + " from x_sertifikasi a where a.biodata_id=:biodataId and a.isdelete=false", resultSetMapping = "sertifikasiAlfiaMapping")

@Entity
@Table(name = "x_sertifikasi")
public class SertifikasiAlfia extends CommonEntity {
    ...
    public SertifikasiAlfia() {
    }

    public SertifikasiAlfia(Long biodataId, String certificateName, String publisher, String validStartYear,
