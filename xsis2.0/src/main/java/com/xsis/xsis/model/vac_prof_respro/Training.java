...
@NamedNativeQuery(name = "Training.getTrainingBiodata", query = "select a.id,a.biodata_id,a.training_name,a.organizer,a.training_year,a.training_duration,a.time_period_id from x_riwayat_pelatihan a "
