...
public class BiodataPengkerDtoKur {
    private long id;
    ...
    public BiodataPengkerDtoKur() {
    }

    public BiodataPengkerDtoKur(long id, Boolean isDelete, long biodataId, String companyName, String joinYear,
