...
public class ResourceProDto {
    ...
    public ResourceProDto(Long id, Long clientId, Date startProject, Date endProject, String department, String picName,
            String name, String userClientName, Long ero, Boolean isEro) {
        this.id = id;
