 ...
 * PengalamanKerjaDto
 */
public class PengalamanKerjaDtoAlfia {
    private long id;
    ...
    public PengalamanKerjaDtoAlfia() {
    }

    public PengalamanKerjaDtoAlfia(long id, long biodataId, String companyName, String city, String country,
            String joinYear, String joinMonth, String resignYear, String resignMonth, String lastPosition,
            String income, Boolean isItRelated, String aboutJob, String exitReason, String notes) {
        this.id = id;
