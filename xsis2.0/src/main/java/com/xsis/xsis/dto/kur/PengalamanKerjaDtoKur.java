 ...
 * PengalamanKerjaDto
 */
public class PengalamanKerjaDtoKur {
    private long id;
    ...
    public PengalamanKerjaDtoKur() {
    }

    public PengalamanKerjaDtoKur(long id, long biodataId, String companyName, String city, String country,
