 ...
 */
@RestController
@RequestMapping(path = "/api/education-dika", produces = "application/json")
@CrossOrigin(origins = "*")
public class EducationAPIDika {

    @Autowired
    private EducationServicesDika educationServices;

    @GetMapping
    public Iterable<EducationDika> findAllEducationVacancy() {
        List<EducationDika> education = new ArrayList<>();
        for (EducationDika educations : educationServices.findAllEducation()) {
    ...
    public ResponseEntity<?> brandById(@PathVariable("id") Long id) {
        Optional<EducationDika> optPendidikan = educationServices.getEducationById(id);
    ...
    public EducationDika postBrand(@RequestBody EducationDika education) {
    ...
    @PutMapping(path = "/{id}")
    public EducationDika putEducationVacancy(@RequestBody EducationDika education) {
        EducationDika educationDetail = educationServices.getEducationById(education.getId()).get();
    ...
    @DeleteMapping("/{id}")
    public EducationDika deleteEducationVacancy(@PathVariable(value = "id") Long id) {
        EducationDika edu = educationServices.getEducationById(id).get();
